...
const LoadingMessage = memo(() => (
  <Message className="flex w-full flex-col items-start gap-2 px-4">
    <div className="group flex w-full flex-col gap-0">
...
const ErrorMessage = memo(({ error }: { error: Error }) => (
  <Message className="not-prose flex w-full flex-col items-start gap-2 px-4">
  ...
  return (
    <div className="flex h-screen flex-col overflow-hidden">
      <ChatContainerRoot className="relative flex-1 space-y-0 overflow-y-auto">
        <ChatContainerContent className="space-y-6 py-4">
      ...
      <div className="inset-x-0 bottom-0 w-full shrink-0 px-4 pb-4">
        <PromptInput
